...
console.log("push前", array3); //なぜかpush後の値が表示されてしまいます・・・

array3.push("コメント4");

console.log("push後", array3);
...
console.log("pop前", array4); //なぜかpop後の値が表示されてしまいます・・・
...
console.log("unshift前", array5); //なぜかunshift後の値が表示されてしまいます・・・
...
console.log("shift前", array6); //なぜかshift後の値が表示されてしまいます・・・
